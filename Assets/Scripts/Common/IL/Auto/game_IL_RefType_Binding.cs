...
{
    unsafe class game_IL_RefType_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(game.IL.RefType);
            args = new Type[]{};
            ...
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("TryGetMethod", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, TryGetMethod_10);
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("GetProperty", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetProperty_11);
            args = new Type[]{typeof(System.String)};
            ...
            app.RegisterCLRMethodRedirection(method, SetProperty_13);
            args = new Type[]{typeof(System.String), typeof(System.Object)};
            method = type.GetMethod("TrySetProperty", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, TrySetProperty_14);



            app.RegisterCLRCreateArrayInstance(type, s => new game.IL.RefType[s]);
        ...
        static StackObject* get_Instance_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            game.IL.RefType instance_of_this_method = (game.IL.RefType)typeof(game.IL.RefType).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* TryGetMethod_10(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            var result_of_this_method = instance_of_this_method.TryGetMethod(@name);
        ...
        static StackObject* GetProperty_11(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* SetProperty_13(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 3);
        ...
        static StackObject* TrySetProperty_14(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 3);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new game.IL.RefType(@fullType, @param);
        ...
        static StackObject* Ctor_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new game.IL.RefType(@fullType);
        ...
        static StackObject* Ctor_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new game.IL.RefType(@instance);
